...
(deffacts Personas
    ...
    (persona (nombre Luis) (sexo H) (edad 35) (tipoPareja H)(numAmigosFacebook 0)(gustos teatro))	
...
?p <- (persona (numAmigosFacebook ?num) (caracter none))
(test (>= ?num 50))
=>
